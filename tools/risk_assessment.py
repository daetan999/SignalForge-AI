...
def assess_opportunity_risks(
    ...
    if profile.data_sensitivity == "unknown":
        risks.append(Risk(
            ...
            impact="The team cannot finalize access controls, residency, logging, or model-data handling.",
            mitigation="Run security discovery and obtain data-owner approval before solution validation.",
    ...
    if (
        ...
        risks.append(Risk(
            ...
            mitigation="Collect expected daily requests, peak concurrency, context size, and latency SLO.",
